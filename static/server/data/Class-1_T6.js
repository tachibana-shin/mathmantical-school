...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/1/1.png")}") 
p.text-h5.text-center Có %text tam giác
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/2/1.png")}") 
p.text-h5.text-center Có %text bông hoa
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/3/1.png")}") 
p.text-h5.text-center Có %text cái thìa
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/4/1.png")}") 
p.text-h5.text-center Có %text bông hoa
    `,
    answer: 10
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/5/1.png")}") 
p.text-h5.text-center Có %text hình tròn
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/6/1.png")}") 
...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/7/1.png")}") 
    `,
    items: ["Đúng", "Sai"],
    answer: 1
  },
...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t6/8/1.png")}") 
    `,
    items: ["Đúng", "Sai"],
    answer: 0
  },
