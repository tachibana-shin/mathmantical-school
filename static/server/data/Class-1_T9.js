...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/14/1.png")}")`,
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/15/1.png")}")`,
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/16/1.png")}")`,
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/17/1.png")}")`,
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/18/1.png")}")`,
    items: ["2, 1", "3, 4", "1, 3", "5, 7"],
    answer: 0
  },
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/19/1.png")}")`,
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t9/20/1.png")}")`,
