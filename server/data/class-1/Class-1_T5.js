...
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/1/1.png") 
p.text-h5.text-center Có %text bông hoa
  ...
  },
    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/2/1.png") 
p.text-h5.text-center Có %text đám mây
  ...
  },
    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/3/1.png") 
p.text-h5.text-center Có %text ngôi sao
  ...
  },
    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/4/1.png") 
p.text-h5.text-center Có %text quả dưa
...

    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/5/1.png") 
p.text-h5.text-center Có %text con cá
  ...
  },
    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/6/1.png") 
...
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/7/1.png")
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/7/2.png")
...
p.grey--text.text--darken-2 Chọn dấu thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/8/1.png")
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/8/2.png")
...
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/9/1.png")
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/9/2.png")
...
p.grey--text.text--darken-2 Chọn số thích hợp
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/10/1.png")
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/10/2.png")
p.text-h5.text-center %text1 > %text2
    `,
...
p.text-h5.text-center 6 %text1 5 %text2 9
...

    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/16/1.png") 
p.text-h5.text-center Có %text con cá trong hình tròn
  ...
  },
    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/17/1.png") 
p.text-h5.text-center Có %text bao nhiêu hình tròn trong hình vuông
  ...
  },
    {
      ...
      question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${process.env.baseURL}/api/resources/assets/class-1/t5/18/1.png") 
