...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/1/1.png")}")
    `,
...
p.grey--text.text--darken-2 Đọc:
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/2/1.png")}")
    `,
...
p.grey--text.text--darken-2 Đọc:
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/3/1.png")}")
    `,
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/4/1.png")}")
p.text-h5.text-center Có %text1 đoạn thẳng và %text2 điểm
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/5/1.png")}")
p.text-h5.text-center Có %text1 đoạn thẳng và %text2 điểm
    `,
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/6/1.png")}")
p.text-h5.text-center Có %text1 điểm và %text2 đoạn thẳng
  ...
  },
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/7/1.png")}")
p.text-h5.text-center Có %text1 đoạn thẳng và %text2 điểm
    `,
  ...
  }, 
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/8/1.png")}")
...
p.grey--text.text--darken-2 Từ A, B, C và D vẽ được bao nhiêu đoạn thẳng?
  ...
  },  
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/12/1.png")}")
p.text-h5.text-center Đoạn thẳng nào dài hơn
  ...
  },  
  {
    ...
    question: `
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/13/1.png")}")
...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/14/1.png")}") 
    `,
    items: ["Đúng", "Sai"],
    answer: 0
  },
...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/15/1.png")}") 
    `,
    items: ["Đúng", "Sai"],
    answer: 1
  },
...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/16/1.png")}") 
    `,
    items: [8, 7, 6, 5],
    answer: 3
  },
...
div.d-flex.align-items-center.justify-content-between
  img(src="${require("@/assets/t17/17/1.png")}") 
    `,
    items: [1, 2, 3, 4],
    answer: 2
  },
